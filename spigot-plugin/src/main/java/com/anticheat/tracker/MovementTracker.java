...
public class MovementTracker {
    ...
    // ── 异常检测阈值（宽松设定，仅做粗略标记，精确检测由后端完成） ──
    // FLY_SPEED_THRESHOLD: 0.8 blocks/tick = 16 blocks/s
    // 覆盖疾跑+速度II(7.86)、船(8.4)、马(14.5)等合法高速状态
    private static final double FLY_SPEED_THRESHOLD = 0.8;
    // SPEED_VARIANCE_THRESHOLD: 0.5（正常疾跑/跳跃/变速移动的方差范围）
    private static final double SPEED_VARIANCE_THRESHOLD = 0.5;
