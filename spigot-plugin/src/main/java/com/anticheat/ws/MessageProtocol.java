...
public final class MessageProtocol {
    ...
    public static final String ACTION_PERSISTENT_WARNING = "persistent_warning";
    public static final String ACTION_VP_UPDATE = "vp_update";

    @SuppressWarnings("unchecked")
    public static String serverStart(String serverId, int maxPlayers, String version, double tps) {
    ...
    /** Backward-compatible overload: defaults TPS to 20 */
    public static String serverStart(String serverId, int maxPlayers, String version) {
        return serverStart(serverId, maxPlayers, version, 20.0);
    }
    ...
    @SuppressWarnings("unchecked")
    public static String heartbeat(double tps) {
        JSONObject msg = new JSONObject();
    ...
    /** Backward-compatible overload: no TPS data */
    public static String heartbeat() {
        return heartbeat(20.0);
    }
