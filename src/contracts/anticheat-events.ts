...
export type AntiCheatEvent =
  // System lifecycle
  | { type: 'system.init'; serverId: string; maxPlayers: number; version: string; tps?: number }
  ...
  | { type: 'penalty'; playerId: string; level: string; action: ActionType | 'kick_ban'; cheatType: CheatType; confidence: Confidence; vp: number; reason: string; autoGenerated: boolean }
  ...
  // Heartbeat (periodic from Spigot)
  | { type: 'heartbeat'; tps?: number }
