...
const BUILDINGS: BuildingDef[] = [
  { id: 'fly_lab',      name: '飞行关押区', cheatType: 'fly',          modelKey: 'building_A', pos: [3, 0, 4],  scale: 3.0, rotationY: 0, doorOffset: [0, 0.05, 5],  size: [8, 12, 6], color: 0x6688aa, roofColor: 0x446688 },
  { id: 'speed_lab',    name: '速度关押区', cheatType: 'speed',        modelKey: 'building_B', pos: [3, 0, 10], scale: 1.8, rotationY: 0, doorOffset: [0, 0.05, 7],  size: [3, 4, 3],  color: 0xf5f0e8, roofColor: 0x44aa44 },
  { id: 'combat_lab',   name: '战斗关押区', cheatType: 'kill_aura',    modelKey: 'building_C', pos: [3, 0, 16], scale: 1.8, rotationY: 0, doorOffset: [0, 0.05, 12], size: [3, 4, 3],  color: 0xf5f0e8, roofColor: 0x4488cc },
  { id: 'xray_lab',     name: '透视关押区', cheatType: 'x_ray',       modelKey: 'building_D', pos: [32, 0, 4], scale: 1.8, rotationY: 0, doorOffset: [0, 0.05, 6],  size: [3, 4, 3],  color: 0xf5f0e8, roofColor: 0xcc8844 },
  { id: 'scaffold_lab', name: '搭桥关押区', cheatType: 'scaffold',     modelKey: 'building_E', pos: [32, 0, 10], scale: 2.5, rotationY: 0, doorOffset: [0, 0.05, 6],  size: [8, 4, 5],  color: 0xf0f0f0, roofColor: 0x888888 },
  { id: 'autoclick_lab',name: '点击关押区', cheatType: 'auto_clicker', modelKey: 'building_F', pos: [32, 0, 16], scale: 2.0, rotationY: 0, doorOffset: [0, 0.05, 12], size: [5, 3, 4],  color: 0xd4a574, roofColor: 0xaa7744 },
  { id: 'reach_lab',    name: '距离关押区', cheatType: 'reach',        modelKey: 'building_G', pos: [17.5, 0, 4], scale: 1.8, rotationY: 0, doorOffset: [0, 0.05, 6],  size: [3, 4, 3],  color: 0xf5f0e8, roofColor: 0xddaa44 },
]
...
export class TownBuilder {
  ...
  isInsideBuilding(x: number, z: number, padding: number = 0.3): string | null {
